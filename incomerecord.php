...
// Fetch only income records from transactions table
$sql = "SELECT * FROM transactions WHERE type = 'income' ORDER BY date DESC";
...
<div class="dash">
 ...
 <div class="back">   
<div class="container">
    <h2 style="color:white;!important" >Income Records</h2>

...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_account'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO account_details (account_name, account_number, email) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $account_name, $account_number, $email);
...
if (isset($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        $_SESSION['success'] = "Account record deleted successfully!";
    } else {
        $_SESSION['error'] = "Error: " . $stmt->error;
    }
    $stmt->close();
...
<body>
    <div class="container">
        ...
        <div class="card p-4 detailcard">
            <h4 class="mb-3"><i class="fa-solid fa-university"></i> Account Details</h4>
            <form method="POST" action="">
                ...
                <button type="submit" name="add_account" class="btn btn-custom w-100" style="width:40px;">
        ...
        <div class="card p-4 mt-4 bankcard">
            <h4 class="mb-3"><i class="fa-solid fa-table"></i> Account Details List</h4>
